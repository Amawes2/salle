    ...
    <head>
        ...
        <script>
            const updateBsTheme = () => {
                ...
                const defaultTheme = getComputedStyle(document.documentElement).getPropertyValue('--default-theme-mode').trim()
            ...
            new MutationObserver(updateBsTheme).observe(document.documentElement, {
                attributes: true,
